...
| ------ | ------------- | ----------------- | ----------------- | ----- |
| [TrollStore / Jailbreak](/OLD-IOS-INSTALL.md) | iOS 14 - 17.0.0* (older iPads up to iOS 18) | No* | Full (Native JIT) | Free |
| [SideStore](/MODERN-IOS-INSTALL.md) | iOS 15+ | First-time setup only | Full (JIT) / Partial (JIT-less) | Free |
